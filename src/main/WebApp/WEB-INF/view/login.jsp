	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-b-160 p-t-50">
				<form class="login100-form validate-form" action="LogUser"   method="POST" >
				...
				<c:out value="${error }"></c:out>
					...
					<div class="wrap-input100 rs1 validate-input" data-validate = "nom is required">
						<input class="input100" type="text" name="nom" value="${user.nom}"/>
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn"> <a href="Acceuil">Sign in</a>
